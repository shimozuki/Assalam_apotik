			...
			<ul>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						@endcan
						@can('view-neraca')
						<li><a class="{{ Request::routeIs('neraca') ? 'active' : '' }}" href="{{route('neraca')}}">Neraca</a></li>
						@endcan
					</ul>
				</li>
				@endcan
				<!-- @can('view-neraca')
				<li class="submenu">
					<a href="#"><i class="fa fa-bar-chart"></i> <span> Neraca</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						@can('view-activa-lancar')
						<li><a class="{{ Request::routeIs('permissions') ? 'active' : '' }}" href="{{route('permissions')}}">Activa Lancar</a></li>
						@endcan
						@can('view-activa-tetap')
						<li><a class="{{ Request::routeIs('roles') ? 'active' : '' }}" href="{{route('roles')}}">Activa Tetap</a></li>
						@endcan
						@can('view-pasiva')
						<li><a class="{{ Request::routeIs('roles') ? 'active' : '' }}" href="{{route('roles')}}">Pasiva</a></li>
						@endcan
						@can('view-modal')
						<li><a class="{{ Request::routeIs('roles') ? 'active' : '' }}" href="{{route('roles')}}">Modal</a></li>
						@endcan
					</ul>
				</li>
				@endcan -->
